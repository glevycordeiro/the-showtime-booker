...
movie_1917 = Movie.create(title: '1917', synopsis: 'lorem', genre: 'drama', duration: 120, poster: 'https://media-cache.cinematerial.com/p/500x/haeorwgk/1917-british-movie-poster.jpg?v=1579166770', age_limit: 16, imdb_url: 'https://www.imdb.com/title/tt8579674/', cinema: Cinema.all.sample)
movie_parasite = Movie.create(title: 'Parasite', synopsis: 'lorem', genre: 'comedy', duration: 90, poster: 'https://fleurcinema.com/filesystem/fleur-cinema/Movies/2019/November/parasite.png', age_limit: 18, imdb_url: 'https://www.imdb.com/title/tt6751668/', cinema: Cinema.all.sample)
movie_judy = Movie.create(title: 'Judy', synopsis: 'lorem', genre: 'musical', duration: 110, poster: 'https://m.media-amazon.com/images/M/MV5BYmE0OTE5NWItMGYyZi00MzUxLWFjN2QtYzBkZGRjZGVmMGFmXkEyXkFqcGdeQXVyNjg2NjQwMDQ@._V1_SY999_SX648_AL_.jpg', age_limit: 14, imdb_url: 'https://www.imdb.com/title/tt7549996/', cinema: Cinema.all.sample)
